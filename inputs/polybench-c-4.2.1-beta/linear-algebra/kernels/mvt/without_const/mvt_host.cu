...
#define cudaCheckKernel() \
  do { \
    ...
    cudaCheckReturn(cudaMalloc((void **) &dev_x1, (120) * sizeof(double)));
    cudaCheckReturn(cudaMalloc((void **) &dev_x2, (120) * sizeof(double)));
    cudaCheckReturn(cudaMalloc((void **) &dev_y_1, (120) * sizeof(double)));
    cudaCheckReturn(cudaMalloc((void **) &dev_y_2, (120) * sizeof(double)));
    
    
    cudaCheckReturn(cudaMemcpy(dev_A, A, (120) * (120) * sizeof(double), cudaMemcpyHostToDevice));
    cudaCheckReturn(cudaMemcpy(dev_x1, x1, (120) * sizeof(double), cudaMemcpyHostToDevice));
    cudaCheckReturn(cudaMemcpy(dev_x2, x2, (120) * sizeof(double), cudaMemcpyHostToDevice));
    cudaCheckReturn(cudaMemcpy(dev_y_1, y_1, (120) * sizeof(double), cudaMemcpyHostToDevice));
    cudaCheckReturn(cudaMemcpy(dev_y_2, y_2, (120) * sizeof(double), cudaMemcpyHostToDevice));
    {
      dim3 k0_dimBlock(32);
      dim3 k0_dimGrid(4);
    ...
    cudaCheckReturn(cudaMemcpy(x1, dev_x1, (120) * sizeof(double), cudaMemcpyDeviceToHost));
    cudaCheckReturn(cudaMemcpy(x2, dev_x2, (120) * sizeof(double), cudaMemcpyDeviceToHost));
