...
#define cudaCheckKernel() \
  do { \
    ...
    cudaCheckReturn(cudaMalloc((void **) &dev__fict_, (40) * sizeof(double)));
    cudaCheckReturn(cudaMalloc((void **) &dev_ex, (60) * (80) * sizeof(double)));
    cudaCheckReturn(cudaMalloc((void **) &dev_ey, (60) * (80) * sizeof(double)));
    cudaCheckReturn(cudaMalloc((void **) &dev_hz, (60) * (80) * sizeof(double)));
    
    
    cudaCheckReturn(cudaMemcpy(dev__fict_, _fict_, (40) * sizeof(double), cudaMemcpyHostToDevice));
    cudaCheckReturn(cudaMemcpy(dev_ex, ex, (60) * (80) * sizeof(double), cudaMemcpyHostToDevice));
    cudaCheckReturn(cudaMemcpy(dev_ey, ey, (60) * (80) * sizeof(double), cudaMemcpyHostToDevice));
    cudaCheckReturn(cudaMemcpy(dev_hz, hz, (60) * (80) * sizeof(double), cudaMemcpyHostToDevice));
    ...
    cudaCheckReturn(cudaMemcpy(ex, dev_ex, (60) * (80) * sizeof(double), cudaMemcpyDeviceToHost));
    cudaCheckReturn(cudaMemcpy(ey, dev_ey, (60) * (80) * sizeof(double), cudaMemcpyDeviceToHost));
    cudaCheckReturn(cudaMemcpy(hz, dev_hz, (60) * (80) * sizeof(double), cudaMemcpyDeviceToHost));
